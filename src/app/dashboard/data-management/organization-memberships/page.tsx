...
const ROLE_GROUPS = [
  ...
  },
  {
    ...
    roles: [
      { name: '부장', level: 80, isLeadership: true },
      { name: '차장', level: 75, isLeadership: true },
      { name: '교구목사', level: 85, isLeadership: true },
      { name: '단장', level: 70, isLeadership: true },
      { name: '교역자', level: 80, isLeadership: true },
    ]
  },
  {
    id: 'regional',
    ...
    roles: [
      { name: '교구장', level: 75, isLeadership: true },
      { name: '부교구장', level: 70, isLeadership: true },
  ...
  },
  {
    ...
    roles: [
      ...
      { name: '엘더', level: 70, isLeadership: true },
  ...
  },
  {
    ...
    roles: [
      ...
      { name: '대장', level: 55, isLeadership: true },
  ...
  },
  {
    ...
    roles: [
      { name: '운영위원', level: 50, isLeadership: false },
      { name: '부감', level: 40, isLeadership: false },
    ]
  },
]
