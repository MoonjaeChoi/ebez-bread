# 에벤에셀 교회 관리 시스템 - 디자인 시스템

## 개요

에벤에셀 교회 관리 시스템을 위한 통합 디자인 시스템입니다. shadcn/ui를 기반으로 하여 일관성 있고 접근 가능한 사용자 인터페이스를 제공합니다.
...
이 디자인 시스템은 에벤에셀 교회 관리 시스템의 일관성 있고 사용자 친화적인 인터페이스를 보장합니다. 지속적인 개선과 업데이트를 통해 더 나은 사용자 경험을 제공할 예정입니다.